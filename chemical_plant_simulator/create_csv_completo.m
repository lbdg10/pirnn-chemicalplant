...
%% Normalization of flow rates ONLY
...
output_scaler_bias = [mean(y_q_R1_notnorm), mean(y_D1_notnorm), mean(y_B1_notnorm), mean(y_B2_notnorm), mean(y_q_R2_notnorm), mean(y_q_R3_notnorm), mean(y_D3_notnorm)];
output_scaler_scale = [max(abs(y_q_R1_notnorm-output_scaler_bias(1))), max(abs(y_D1_notnorm-output_scaler_bias(2))), max(abs(y_B1_notnorm-output_scaler_bias(3))), max(abs(y_B2_notnorm-output_scaler_bias(4))), max(abs(y_q_R2_notnorm-output_scaler_bias(5))), max(abs(y_q_R3_notnorm-output_scaler_bias(6))), max(abs(y_D3_notnorm-output_scaler_bias(7)))];
output_scaler_scale_portata = max([output_scaler_scale(1) output_scaler_scale(2) output_scaler_scale(3) output_scaler_scale(4) output_scaler_scale(5) output_scaler_scale(6)  output_scaler_scale(7)]);
...
y1_norm = ((y_q_R1_notnorm - output_scaler_bias(1)) ./ output_scaler_scale_portata) .* y_xR1_1_notnorm;
y2_norm = ((y_q_R1_notnorm - output_scaler_bias(1)) ./ output_scaler_scale_portata) .* y_xR1_2_notnorm;
y3_norm = ((y_q_R1_notnorm - output_scaler_bias(1)) ./ output_scaler_scale_portata) .* y_xR1_3_notnorm;
y4_norm = ((y_q_R1_notnorm - output_scaler_bias(1)) ./ output_scaler_scale_portata) .* y_xR1_4_notnorm;
y5_norm = ((y_D1_notnorm - output_scaler_bias(2)) ./ output_scaler_scale_portata) .* y_xd1_1_notnorm;
y6_norm = ((y_D1_notnorm - output_scaler_bias(2)) ./ output_scaler_scale_portata) .* y_xd1_2_notnorm;
y7_norm = ((y_D1_notnorm - output_scaler_bias(2)) ./ output_scaler_scale_portata) .* y_xd1_3_notnorm;
y8_norm = ((y_D1_notnorm - output_scaler_bias(2)) ./ output_scaler_scale_portata) .* y_xd1_4_notnorm;
y9_norm = ((y_B1_notnorm - output_scaler_bias(3)) ./ output_scaler_scale_portata) .* y_xb1_1_notnorm;
y10_norm = ((y_B1_notnorm - output_scaler_bias(3)) ./ output_scaler_scale_portata) .* y_xb1_2_notnorm;
y11_norm = ((y_B1_notnorm - output_scaler_bias(3)) ./ output_scaler_scale_portata) .* y_xb1_3_notnorm;
y12_norm = ((y_B1_notnorm - output_scaler_bias(3)) ./ output_scaler_scale_portata) .* y_xb1_4_notnorm;
y13_norm = ((y_B2_notnorm - output_scaler_bias(4)) ./ output_scaler_scale_portata) .* y_xb2_1_notnorm;
y14_norm = ((y_B2_notnorm - output_scaler_bias(4)) ./ output_scaler_scale_portata) .* y_xb2_2_notnorm;
y15_norm = ((y_B2_notnorm - output_scaler_bias(4)) ./ output_scaler_scale_portata) .* y_xb2_3_notnorm;
y16_norm = ((y_B2_notnorm - output_scaler_bias(4)) ./ output_scaler_scale_portata) .* y_xb2_4_notnorm;
y17_norm = ((y_q_R2_notnorm - output_scaler_bias(5)) ./ output_scaler_scale_portata) .* y_xR2_1_notnorm;
y18_norm = ((y_q_R2_notnorm - output_scaler_bias(5)) ./ output_scaler_scale_portata) .* y_xR2_2_notnorm;
y19_norm = ((y_q_R2_notnorm - output_scaler_bias(5)) ./ output_scaler_scale_portata) .* y_xR2_3_notnorm;
y20_norm = ((y_q_R2_notnorm - output_scaler_bias(5)) ./ output_scaler_scale_portata) .* y_xR2_4_notnorm;
y21_norm = ((y_q_R3_notnorm - output_scaler_bias(6)) ./ output_scaler_scale_portata) .* y_xR3_1_notnorm;
y22_norm = ((y_q_R3_notnorm - output_scaler_bias(6)) ./ output_scaler_scale_portata) .* y_xR3_2_notnorm;
y23_norm = ((y_q_R3_notnorm - output_scaler_bias(6)) ./ output_scaler_scale_portata) .* y_xR3_3_notnorm;
y24_norm = ((y_q_R3_notnorm - output_scaler_bias(6)) ./ output_scaler_scale_portata) .* y_xR3_4_notnorm;
y25_norm = ((y_D3_notnorm - output_scaler_bias(7)) ./ output_scaler_scale_portata) .* y_xd3_1_notnorm;
y26_norm = ((y_D3_notnorm - output_scaler_bias(7)) ./ output_scaler_scale_portata) .* y_xd3_2_notnorm;
y27_norm = ((y_D3_notnorm - output_scaler_bias(7)) ./ output_scaler_scale_portata) .* y_xd3_3_notnorm;
y28_norm = ((y_D3_notnorm - output_scaler_bias(7)) ./ output_scaler_scale_portata) .* y_xd3_4_notnorm;


%% Normalization of the products for channel
input_scaler_bias = [mean(u_R1_notnorm), mean(u_R2_notnorm), mean(u_R3_notnorm), mean(u_F0A_notnorm)];
input_scaler_scale = [max(abs(u_R1_notnorm - input_scaler_bias(1))), max(abs(u_R2_notnorm - input_scaler_bias(2))), max(abs(u_R3_notnorm - input_scaler_bias(3))), max(abs(u_F0A_notnorm - input_scaler_bias(4)))];
...
u1_norm = (u_R1_notnorm - input_scaler_bias.input_scaler_bias(1)) ./ input_scaler_scale_common.input_scaler_scale_common;
...
y1_norm = (y1 - output_scaler_bias.output_scaler_bias(1)) ./ output_scaler_scale_common.output_scaler_scale_common;
y2_norm = (y2 - output_scaler_bias.output_scaler_bias(2)) ./ output_scaler_scale_common.output_scaler_scale_common;
y3_norm = (y3 - output_scaler_bias.output_scaler_bias(3)) ./ output_scaler_scale_common.output_scaler_scale_common;
y4_norm = (y4 - output_scaler_bias.output_scaler_bias(4)) ./ output_scaler_scale_common.output_scaler_scale_common;
y5_norm = (y5 - output_scaler_bias.output_scaler_bias(5)) ./ output_scaler_scale_common.output_scaler_scale_common;
y6_norm = (y6 - output_scaler_bias.output_scaler_bias(6)) ./ output_scaler_scale_common.output_scaler_scale_common;
y7_norm = (y7 - output_scaler_bias.output_scaler_bias(7)) ./ output_scaler_scale_common.output_scaler_scale_common;
y8_norm = (y8 - output_scaler_bias.output_scaler_bias(8)) ./ output_scaler_scale_common.output_scaler_scale_common;
y9_norm = (y9 - output_scaler_bias.output_scaler_bias(9)) ./ output_scaler_scale_common.output_scaler_scale_common;
y10_norm = (y10 - output_scaler_bias.output_scaler_bias(10)) ./ output_scaler_scale_common.output_scaler_scale_common;
y11_norm = (y11 - output_scaler_bias.output_scaler_bias(11)) ./ output_scaler_scale_common.output_scaler_scale_common;
y12_norm = (y12 - output_scaler_bias.output_scaler_bias(12)) ./ output_scaler_scale_common.output_scaler_scale_common;
y13_norm = (y13 - output_scaler_bias.output_scaler_bias(13)) ./ output_scaler_scale_common.output_scaler_scale_common;
y14_norm = (y14 - output_scaler_bias.output_scaler_bias(14)) ./ output_scaler_scale_common.output_scaler_scale_common;
y15_norm = (y15 - output_scaler_bias.output_scaler_bias(15)) ./ output_scaler_scale_common.output_scaler_scale_common;
y16_norm = (y16 - output_scaler_bias.output_scaler_bias(16)) ./ output_scaler_scale_common.output_scaler_scale_common;
y17_norm = (y17 - output_scaler_bias.output_scaler_bias(17)) ./ output_scaler_scale_common.output_scaler_scale_common;
y18_norm = (y18 - output_scaler_bias.output_scaler_bias(18)) ./ output_scaler_scale_common.output_scaler_scale_common;
y19_norm = (y19 - output_scaler_bias.output_scaler_bias(19)) ./ output_scaler_scale_common.output_scaler_scale_common;
y20_norm = (y20 - output_scaler_bias.output_scaler_bias(20)) ./ output_scaler_scale_common.output_scaler_scale_common;
