...
%     yxB1_3(i,1) = i;
%     yxB1_4(i,1) = i;
%     uR2(i,2) = u_R2_notnorm(9000-1+i);
%     uR3(i,2) = u_R3_notnorm(9000-1+i);
%     uF0A(i,2) = u_F0A_notnorm(9000-1+i);
%     yqR2(i,2) = y_q_R2_notnorm(9000-1+i);
%     yxR2_1(i,2) = y_xR2_1_notnorm(9000-1+i);
%     yxR2_2(i,2) = y_xR2_2_notnorm(9000-1+i);
%     yxR2_3(i,2) = y_xR2_3_notnorm(9000-1+i);
%     yxR2_4(i,2) = y_xR2_4_notnorm(9000-1+i);
%     yqR3(i,2) = y_q_R3_notnorm(9000-1+i);
%     yxR3_1(i,2) = y_xR3_1_notnorm(9000-1+i);
%     yxR3_2(i,2) = y_xR3_2_notnorm(9000-1+i);
%     yxR3_3(i,2) = y_xR3_3_notnorm(9000-1+i);
%     yxR3_4(i,2) = y_xR3_4_notnorm(9000-1+i);
%     yB1(i,2) = y_B1_notnorm(9000-1+i);
%     yxB1_1(i,2) = y_xb1_1_notnorm(9000-1+i);
%     yxB1_2(i,2) = y_xb1_2_notnorm(9000-1+i);
%     yxB1_3(i,2) = y_xb1_3_notnorm(9000-1+i);
%     yxB1_4(i,2) = y_xb1_4_notnorm(9000-1+i);
% end
% 
% xk0_mod = 0.9*ones(3, 1);