...
in = 30;
y_R3 = out_y(in:end,1);
y_xR3_1 = out_y(in:end,2);
y_xR3_2 = out_y(in:end,3);
y_xR3_3 = out_y(in:end,4);
y_xR3_4 = out_y(in:end,5);
y_real1 = y_R3.*y_xR3_1;
y_real2 = y_R3.*y_xR3_2;
y_real3 = y_R3.*y_xR3_3;
y_real4 = y_R3.*y_xR3_4;

y_mod1 = zeros(size(y_R3,1),1);
y_mod2 = zeros(size(y_R3,1),1);
y_mod3 = zeros(size(y_R3,1),1);
y_mod4 = zeros(size(y_R3,1),1);
for i = 1:size(y_R3,1)
...
figure; 
subplot(2,2,1); plot(y_real1); hold on; plot(y_mod1); title('k2=10');
subplot(2,2,2); plot(y_real2); hold on; plot(y_mod2)
subplot(2,2,3);plot(y_real3); hold on; plot(y_mod3)
subplot(2,2,4);plot(y_real4); hold on; plot(y_mod4)
